...
import { Toast, MarketResearchReport } from '../types.ts';
import { generateMarketResearchReport } from '../services/geminiService.ts';
import { Loader, Search, FileText, AlertTriangle } from './Icons.tsx';
