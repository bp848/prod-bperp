...
// FIX: Corrected import paths from `../../` to `../` and added file extensions.
import { allBusinessPlans } from '../data/businessPlanData.ts';
import { BusinessPlan, EmployeeUser } from '../types.ts';
