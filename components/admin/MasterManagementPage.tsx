...
import TitleModal from './TitleModal'; // New: Import TitleModal
...
interface MasterManagementPageProps {
  ...
  titles: Title[]; // New: Add titles to props
  ...
  onSaveTitle: (item: Partial<Title>) => Promise<void>; // New: Add title handler
  onDeleteTitle: (id: string) => Promise<void>; // New: Add title handler
...
const MasterManagementPage: React.FC<MasterManagementPageProps> = (props) => {
  ...
  const tabs: {id: Tab, label: string}[] = [
      ...
      { id: 'titles', label: '役職管理' }, // New: Add titles tab
  ];
  ...
  return (
    <div className="space-y-6">
        ...
        {activeTab === 'titles' && <TitlesManager {...props} />} {/* New: Render TitlesManager */}
    </div>
  );
};
