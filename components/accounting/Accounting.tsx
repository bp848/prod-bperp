...
const AccountingPage: React.FC<any> = (props) => {
    const { page, journalEntries, accountItems, onAddEntry, addToast, requestConfirmation, jobs, applications, onNavigate, customers, allUsers, onRefreshData, allocationDivisions } = props;
    ...
    switch(page as Page) {
        ...
        case 'hr_labor_cost':
            return <LaborCostManagement users={allUsers || []} />;
