...
import { Loader, CheckCircle, AlertTriangle, FileText, ArrowRight } from '../Icons.tsx';
import { Toast, ClosingChecklistItem, Job, ApplicationWithDetails, Page, JournalEntry } from '../../types.ts';
import { generateClosingSummary } from '../../services/geminiService.ts';
