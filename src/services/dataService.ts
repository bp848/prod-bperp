...
export async function resolveUserSession(authUser: { id: string; email?: string | null }) {
  ...
  return {
    ...
    departmentName: null, // 必要なら別途 departments から解決
    ...
    employeeNumber: null, // Not in users table as per patch, explicitly null
    salary: null, // Not in users table as per patch, explicitly null
  };
}
